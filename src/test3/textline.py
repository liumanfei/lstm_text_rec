鱿鲂鲅鲆鲇鲈稣鲋鲎鲐鲑鲒鲔鲕鲚鲛鲞鲟鲠鲡鲢鲣鲥鲦鲧鲨鲩鲭鲮鲰鲱鲲鲳鲴鲵鲶鲷鲺鲻鲼鲽鳅鳆鳇鳊鳋鱽鱾鲀鲃鲉鲊鲌鲏鲙鲪鲬鲯鲹鲾鳀鳁鳂鳈鳉鳑鳚鳡鳌鳎鳏鳐鳓鳔鳕鳗鳘鳙鳜鳝鳟鳢靼鞅鞑鞒鞔鞯鞫鞣鞲鞴骱骰骷鹘骶骺骼髁髀髅髂髋髌髑魅魃魇魉魈魍魑飨餍餮饕饔髟髡髦髯髫髻髭髹鬈鬏鬟鬣麽麾縻麂麇麈麋麒鏖麝麟黛黜黝黠黟黢黩黧黥黪黯鼢鼬鼯鼹鼷鼽鼾齄鳤鸤鸮鸰鸻鸼鹀鹐鹝鹟鹠鹡鹮鹲黇鼒鼩鼫鼱齁齉龁 '

def print_label(label_int):
	#label_int is a list of labels of a text line 
	label_str=[]
	for i in range(0,len(label_int)):
		label_str.append(char_str_1[label_int[i]])
	print(label_str)
def get_label_str(label_int):
	...
	for i in range(0,len(label_int)):
		try:
			...
			label_str.append(' ')
			print('IndexError:',label_int[i])
		except TypeError:
			label_str.append(' ')
			print('TypeError:',label_int[i])
	return label_str
		...
		if line[2*i]==65535 :
			if line[2*i+1]!=65535:
				if stroke_point_count>=2:
					char_sparse_diff.append([line[2*i-2]-previous_x,line[2*i-1]-previous_y,int(bool(skip_count)),int(not bool(skip_count))])
			...
			if skip_count>0 or line[2*i-2]==65535:
				char_sparse_diff.append([line[2*i]-previous_x,line[2*i+1]-previous_y,1,0])
				previous_x = line[2*i]
				previous_y = line[2*i+1]
				if line[2*i-1]==65535:
				...
				if(T_dist_m>TdistConst and T_cos<TcosConst):
					char_sparse_diff.append([delta_xim,delta_yim,int(bool(skip_count)),int(not bool(skip_count))])
					previous_x = line[2*i-2]
					previous_y = line[2*i-1]
			stroke_point_count+=1
			skip_count=0
	char_sparse_diff.append([x_max-x_last+x_first-x_min,line[1]-line[len(line)-5],1,0])
	line_sparse_diff.append(char_sparse_diff)
...
def get_sparse_diff_char(data_label, TdistConst= 8,TcosConst = 0.99):
	...
	for i in range(int(len(char)/2)):
		if char[2*i]==65535 :
			if char[2*i+1]!=65535:
				if stroke_point_count>=2:
					char_sparse_diff.append([char[2*i-2]-previous_x,char[2*i-1]-previous_y,int(bool(skip_count)),int(not bool(skip_count))])
			...
			if skip_count>0 or char[2*i-2]==65535:
				char_sparse_diff.append([char[2*i]-previous_x,char[2*i+1]-previous_y,1,0])
				previous_x = char[2*i]
				previous_y = char[2*i+1]
				# if char[2*i-1]==65535:
			...
			stroke_point_count+=1
			skip_count=0
	char_sparse_diff.append([x_max-x_last,y_last,-1,-1])
	char_sparse_diff.append([x_first-x_min,y_first,-1,-1])
...
def sample_generator(data_label,absolute_max_label_len,time_dense_size,channel = 4):
	...
	# plot_char3(data_label)
	# tmp = 0
	# print('time dense', time_dense_size)
	while point_count+chars_point_num[char_index] <= time_dense_size and len(sample_label)<absolute_max_label_len :
		...
		if not isinstance(label[char_index],(np.int64,int)):
			print(type(label[char_index]))
			print('textline',char_index,label[char_index])
			# input('wait462')

		if label[char_index]<7357 and label[char_index]>=0 and isinstance(label[char_index],(np.int64,int)) and label[char_index]!= None:
...
def sample_generator_group(dataset,absolute_max_label_len,time_dense_size,channel = 4):
	sample_data = np.zeros( [time_dense_size, channel])
	sample_label = []
	point_count=0
	...
	while point_count+len(dataset[random_index][0])<time_dense_size and len(sample_label)<absolute_max_label_len:
		...
		if not isinstance(dataset[random_index][1][0],(int,np.int64)):
			print('char',dataset[random_index][1][0])
			input('wait sample_generator_group')

		if dataset[random_index][1][0]<7357 and dataset[random_index][1][0] >= 0 and isinstance(dataset[random_index][1][0],(int,np.int64))and dataset[random_index][1][0]!=None:
			sample_data[point_count:point_count+len(dataset[random_index][0])-1] = dataset[random_index][0][:-1]
			note = sample_data[point_count-1]
			if point_count>0:
				sample_data[point_count-1] = [note[0]+dataset[random_index][0][-1][0],dataset[random_index][0][-1][1]-note[1],1,0]
...
def processing_write_char_set(data_dir,label_dir,file_name,time_dense_size, start = None, end = None):
	...
	with open(label_dir,'rt') as f:
		...
		for line in lines:
			...
			if elements[0]>3 and elements[1]<7357:
				data_label_list.append([data_int[(point_num_sum*2):((point_num_sum+elements[0])*2)],[int(elements[1])]]) 
			else:
				print(label_dir,elements,data_int[(point_num_sum*2):((point_num_sum+elements[0])*2)])
				print('illegal label: ',elements[1])
				plot_char(data_int[(point_num_sum*2):((point_num_sum+elements[0])*2)])
	...
	return data_sparse_diff_label#data_list,label_int_list#,max_label_len,label_str_list
	...
	with open(label_dir,'rt') as f:
		...
		for line in lines:
			...
			if elements[0]>3:
				...
				data_label_list.append([data_int[(point_num_sum*2):((point_num_sum+elements[0])*2)],np.array(elements[1:])-1]) 
			else:
				print(label_dir,elements,data_int[(point_num_sum*2):((point_num_sum+elements[0])*2)])
			point_num_sum += elements[0]
...
def decode_batch(test_func, word_batch):
	...
	for j in range(out.shape[0]):
		...
		outstr=[char_str_1[c] for c in out_best]
		while ' 'in outstr:
			outstr.remove(' ')
		ret.append(outstr)
	return ret
class batch_generator(Callback): #dataset:[0]xy data with 65535,[1]label_int
	def __init__(self, data_label_list, batch_size = 32, label_classes = len(char_str)+1,absolute_max_label_len = 20,
				 channel =4 ,time_dense_size = 160,char_data_label=None):
		...
		self.blank_label = len(char_str_1)-1
	...
	def get_batch(self,  cur_sample_index, train=True):
		...
		labels = np.ones([self.batch_size, self.absolute_max_label_len])*(-1)
		label_length = np.zeros([self.batch_size, 1])
		source_str = []
		sample_count = 0

		# input_length = np.ones([self.batch_size, 1])*38
		# labels = np.ones([self.batch_size, self.absolute_max_label_len])*(1)
		# label_length = np.ones([self.batch_size, 1])
		# source_str = [[' ']*self.batch_size]
		...
		for i in range(0, self.batch_size):
			...
			if train and i > self.batch_size:
				...
				sample_data = None
				sample_label = None
				while sample_data==None or sample_label==None:					
				...
				if len(sample_data)>0 and len(sample_label)>0:
					...
					X_data[i,:]=X_data[i-1,:]
					labels[i,:]=labels[i-1,:]
					sample_label = [labels[i-1]]
					while -1 in sample_label:
						sample_label.remove(-1)
					print('\nnot normal\nlabels:',labels)
					# print(X_data,sample_label)
				else:
					labels[i][0]=self.blank_label
					sample_label.append(self.blank_label)

				# print('sample_label:',sample_label)
				input_length[i] = self.time_dense_size/4-2 #ctc的time_dim
	...
	def next_val(self):
		while 1:
			if self.cur_sample_index+self.batch_size >= self.dataset_size:
				self.cur_sample_index = (self.cur_sample_index+self.batch_size) % self.cur_sample_index
			ret,sample_count = self.get_batch(self.cur_sample_index, train=False)
...
class VizCallback(Callback):
	...
	def on_train_begin(self, logs={}):  
		...
		print('train time from: ',run_time)
	...
	def on_epoch_end(self, epoch, logs={}):
		...
		acc = str(0)
		print('epoch finished at: ',datetime.datetime.now().strftime('%Y%m%d_%H:%M:%S'),'begin testing:')
		# acc = str(1-self.show_edit_distance(self.train_set_size,self.train_sample_gen))[:6]
		val_loss = str(logs.get('val_loss'))[:6]	
		val_acc = str(1-self.show_edit_distance(self.validation_set_size,self.validation_sample_gen))[:6]
		print((str(epoch)+'epoch test finished at'+datetime.datetime.now().strftime('%Y%m%d_%H:%M:%S')+'\t\ttrain loss:'+loss+'\t\t train acc:'+acc +'\t\tval_loss:'+val_loss+'\t\tval_acc:'+val_acc+'\n'))
...
def train(start_epoch, stop_epoch):
	...
	train_sparse_diff_data_dir = '../data/train_sparse_diff_channel_4.txt'
	char_sparse_diff_data_dir = '../data/char_sparse_diff_channel_4.txt'
	test_sparse_diff_data_dir = '../data/test_sparse_diff_channel_4.txt'
	...
	data_charset=processing_write_char_set(char_dir,char_label_dir,char_sparse_diff_data_dir,time_dense_size = time_dense_size)
	# data_charset= processing_write_char_set(char_dir,char_label_dir,char_sparse_diff_data_dir,time_dense_size = time_dense_size,start =0,end = 1000)#,tesize,time_dense_size)
	# input('wait 798')
	...
	# inner = Dense(train_data.get_output_size(), kernel_initializer='he_normal',name='dense2')(concatenate([gru_2, gru_2b]))
	...
	gru_1 = GRU(rnn_size[0], return_sequences=True, kernel_initializer='he_normal',name = 'gru1')(input_data)
	gru_1_reshape = Reshape((40,rnn_size[0]*4))(gru_1)
	dense_1 = Dense(rnn_size[0]*4, kernel_initializer='he_normal',name='dense1',trainable=True)(gru_1_reshape)
	# print(gru_1)
	gru_2 = GRU(rnn_size[1], return_sequences=True, kernel_initializer='he_normal',name = 'gru2')(dense_1)
	dense_2 = Dense(train_data.get_output_size(), kernel_initializer='he_normal',name='dense2',trainable=True)(gru_2)
	...
	record = VizCallback(out_txt_path = record_txt_name , model_file_dir = model_file_dir,test_func=test_func,
						train_sample_gen = train_data.next_val(),train_set_size=train_data.get_dataset_size(),
						validation_sample_gen = test_data.next_val(),validation_set_size=test_data.get_dataset_size(),
						initial_epoch=start_epoch)
	model.fit_generator(generator=train_data.next_train(), steps_per_epoch=1392,#1391,int(train_data.get_dataset_size()/minibatch_size),
						epochs=stop_epoch, validation_data=test_data.next_val(), 
						validation_steps=int(test_data.get_dataset_size()/minibatch_size),#shuffle=True,
